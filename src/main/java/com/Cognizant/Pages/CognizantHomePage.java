...
public class CognizantHomePage extends TestBase {
	...
	By companyappsLocator = By.xpath("//div[@id='header-menu-item-AppsAndTools']//button[3]");

	By companyappsnameLocator = By.xpath("//*[@id=\"mCSB_20_container\"]/ul/li/apps-and-tools-tab-item/div/a/span[2]");
